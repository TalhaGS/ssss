...
module.exports.run = async (client, message, args, durum, kanal) => {
    if (!message.guild) return;
        ...
        let loading = await message.channel.send(`Veriler yükleniyor...`)
                ...
                const background = await loadImage("https://cdn.discordapp.com/attachments/852824522184065035/972147368604622878/meriazrank.png")
                ...
                const image = new Canvas(478, 180)
                    ...
                    image.printText(` LvL.`, 380, 110, 150)
					
                    image.setColor("#fff")
					image.setTextFont('14px Arial Black')
                    image.printText(`LvL.`, 380, 150, 150)
					image.save()
                ...
                const attachment = new MessageAttachment(image.toBuffer(), 'meriaz-level.png');
                let embed = new MessageEmbed().setColor("0b7888").attachFiles(attachment).setImage('attachment://meriaz-level.png')
